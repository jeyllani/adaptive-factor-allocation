...
\begin{tabular}{l*{5}{r}}
\toprule
\textbf{Signal} & \textbf{Avg P1} & \textbf{Avg P10} & \textbf{Total} & \textbf{P1\%} & \textbf{P10\%} \\
\midrule
\multicolumn{6}{l}{\textit{Panel A: Profitability}} \\
...
\addlinespace
\multicolumn{6}{l}{\textit{Panel B: Investment}} \\
...
\addlinespace
\multicolumn{6}{l}{\textit{Panel C: Accruals \& Quality}} \\
...
\addlinespace
\multicolumn{6}{l}{\textit{Panel D: Liquidity \& Solvency}} \\
...
\addlinespace
\multicolumn{6}{l}{\textit{Panel E: Operating Efficiency}} \\
